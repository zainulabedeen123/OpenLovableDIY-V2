    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a1a] via-[#2d4a7c] to-[#e67e9f]">
      ...
      <main className="relative z-10 px-6 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="max-w-5xl mx-auto text-center w-full">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-sm rounded-full text-white/90 text-base mb-12 border border-white/20">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold text-white mb-8 leading-tight">
            ...
            <span className="inline-flex items-center gap-4">
              <svg className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 text-[#ff6b6b]" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"/>
              </svg>
              OpenLovable
            </span>
          ...
          {/* Input Card */}
          <div className="bg-[#2a2a2a] rounded-3xl p-8 border border-white/10 shadow-2xl max-w-4xl mx-auto">
            <div className="flex items-center gap-5 mb-6">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-white placeholder-gray-500 focus:outline-none text-xl py-2"
              />
              <div className="flex items-center gap-4">
                <button className="p-3 text-gray-400 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  disabled={!url.trim()}
                  className="p-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl hover:from-gray-500 hover:to-gray-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
