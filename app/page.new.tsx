    ...
    const initializePage = async () => {
      ...
      if (storedUrl) {
        ...
        if (detailsParam) {
          ...
          setHomeContextInput(`${styleName} style design`);
        }
...
Tip: I automatically detect and install npm packages from your code imports (like react-router-dom, axios, etc.)`, 'system');
            ...
            <div className="flex-1 overflow-y-auto p-2 scrollbar-hide">
              <div className="text-sm">
                ...
                >
                  ...
                  {expandedFolders.has('app') ? (
                    <BsFolder2Open className="w-6 h-6 text-blue-500" />
                  ) : (
                        ...
                        <div key={dir} className="mb-1">
                          {dir && (
                            ...
                            >
                              ...
                              {expandedFolders.has(dir) ? (
                                <BsFolder2Open className="w-6 h-6 text-yellow-600" />
                              ) : (
                                <BsFolderFill className="w-5 h-5 text-yellow-600" />
                              )}
  ...
  const getFileIcon = (fileName: string) => {
    ...
    if (ext === 'jsx' || ext === 'js') {
      return <SiJavascript className="w-6 h-6 text-yellow-500" />;
    } else if (ext === 'tsx' || ext === 'ts') {
      return <SiReact className="w-6 h-6 text-blue-500" />;
    } else if (ext === 'css') {
      return <SiCss3 className="w-6 h-6 text-blue-500" />;
    } else if (ext === 'json') {
      return <SiJson className="w-6 h-6 text-gray-600" />;
    } else {
...
Focus on the key sections and content, making it clean and modern while preserving visual assets.`;
  ...
  const handleSubmit = () => {
    ...
    // Set the states needed by the generation logic
    setHomeUrlInput(url);
    setHomeContextInput(selectedStyle);
    setTargetUrl(url);
    setShowHomeScreen(false);
    
    // Switch to the generation view
    setView('generation');
    ...
    <HeaderProvider>
      {view === 'home' ? (
        ...
        <div className="min-h-screen bg-background-base">
          ...
          <section className="overflow-x-clip" id="home-hero">
            <div className="pt-28 lg:pt-254 lg:-mt-100 pb-115 relative" id="hero-content">
              ...
              <div className="relative container px-16">
                ...
                <p className="text-center text-body-large">
                  Turn any website into code. In seconds.
                </p>
                <a
            ...
            <div className="container lg:contents !p-16 relative -mt-90">
              ...
              <div className="mx-auto w-full max-w-[552px] relative z-[11] lg:z-[2] rounded-20 -mt-30 lg:-mt-30">
                <div
        ...
        <div className="font-sans bg-background text-foreground h-screen flex flex-col">
          {/* Home Screen Overlay - keeping for backwards compatibility */}
          {showHomeScreen && (
      ...
      <div className="bg-white px-6 py-3 border-b border-border-faint flex items-center justify-between shadow-sm">
        <HeaderBrandKit />
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="px-4 py-2 text-sm bg-white border border-border-faint rounded-10 hover:border-black-alpha-24 focus:outline-none focus:ring-2 focus:ring-heat-100 focus:border-transparent transition-all"
          >
            {appConfig.ai.availableModels.map(model => (
              <option key={model} value={model}>
                {model.includes('claude') ? `Claude ${model.split('-')[2]}` : 
          ...
          <button 
            ...
            className="p-6 rounded-md transition-all bg-black text-white hover:bg-gray-800"
          ...
          <button 
            ...
            className="p-6 rounded-md transition-all bg-black text-white hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="inline-flex items-center gap-2 bg-heat-100 text-white px-4 py-2 rounded-10 text-sm font-medium shadow-sm">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="px-4 py-2 bg-card border-b border-border flex justify-between items-center">
            <div className="flex items-center gap-4">
              <div className="flex bg-[#36322F] rounded-lg p-2 gap-2">
                <button
              ...
              {sandboxData && !generationProgress.isGenerating && (
                <>
                  <a 
                    ...
                    className="p-6 rounded-md transition-all bg-black text-white hover:bg-gray-800 inline-block"
                  >
                    <svg className="w-24 h-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
